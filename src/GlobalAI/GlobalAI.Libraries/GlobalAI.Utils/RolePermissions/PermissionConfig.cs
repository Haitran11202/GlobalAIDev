...
//                { Permissions.CoreMsbPrefix_DanhSach, new PermissionContent { PermissionType = PermissionTypes.Table, PermissionInWeb = PermissionInWebs.Core, ParentKey = Permissions.CoreMenu_WhitelistIp, Description = "Danh sách" } },
...
//                // Phong ban
//                { Permissions.CoreMenu_PhongBan, new PermissionContent { PermissionType = PermissionTypes.Menu, PermissionInWeb = PermissionInWebs.Core, ParentKey = Permissions.CoreMenu_PhongBan, Description = "Menu phòng ban" } },
...
//            { Permissions.RealStateChuDT_DanhSach, new PermissionContent { PermissionType = PermissionTypes.Table, PermissionInWeb = PermissionInWebs.RealState, ParentKey = Permissions.RealStateMenuCSPhanPhoi, Description = "Danh sách" } },
//            { Permissions.RealStateChuDT_ThemMoi, new PermissionContent { PermissionType = PermissionTypes.ButtonAction, PermissionInWeb = PermissionInWebs.RealState, ParentKey = Permissions.RealStateMenuCSPhanPhoi, Description = "Thêm mới" } },
//            { Permissions.RealStateChuDT_Xoa, new PermissionContent { PermissionType = PermissionTypes.ButtonAction, PermissionInWeb = PermissionInWebs.RealState, ParentKey = Permissions.RealStateMenuCSPhanPhoi, Description = "Xoá" } },
//            { Permissions.RealStateChuDT_KichHoatOrHuy, new PermissionContent { PermissionType = PermissionTypes.ButtonAction, PermissionInWeb = PermissionInWebs.RealState, ParentKey = Permissions.RealStateMenuCSPhanPhoi, Description = "Kích hoạt/Huỷ" } },
//            { Permissions.RealStateChuDT_ThongTinChuDauTu, new PermissionContent { PermissionType = PermissionTypes.Page, PermissionInWeb = PermissionInWebs.RealState, ParentKey = Permissions.RealStateMenuCSPhanPhoi, Description = "Thông tin chủ đầu tư" } },
//            // Thông tin chung
...
//            { Permissions.RealStateProjectOverview_TienIchHeThong_DanhSach, new PermissionContent { PermissionType = PermissionTypes.Table, PermissionInWeb = PermissionInWebs.RealState, ParentKey = Permissions.RealStateProjectOverview_TienIch, Description = "Danh sách tiện ích hệ thống" } },
//            { Permissions.RealStateProjectOverview_TienIchHeThong_QuanLy, new PermissionContent { PermissionType = PermissionTypes.ButtonAction, PermissionInWeb = PermissionInWebs.RealState, ParentKey = Permissions.RealStateProjectOverview_TienIchHeThong_DanhSach, Description = "Quản lý tiện ích hệ thống" } },

//            { Permissions.RealStateProjectOverview_TienIchKhac_DanhSach, new PermissionContent { PermissionType = PermissionTypes.Table, PermissionInWeb = PermissionInWebs.RealState, ParentKey = Permissions.RealStateProjectOverview_TienIch, Description = "Danh sách tiện ích khác" } },
//            { Permissions.RealStateProjectOverview_TienIchKhac_ThemMoi, new PermissionContent { PermissionType = PermissionTypes.ButtonAction, PermissionInWeb = PermissionInWebs.RealState, ParentKey = Permissions.RealStateProjectOverview_TienIchKhac_DanhSach, Description = "Thêm mới tiện ích khác" } },
//            { Permissions.RealStateProjectOverview_TienIchKhac_CapNhat, new PermissionContent { PermissionType = PermissionTypes.ButtonAction, PermissionInWeb = PermissionInWebs.RealState, ParentKey = Permissions.RealStateProjectOverview_TienIchKhac_DanhSach, Description = "Cập nhật tiện ích khác" } },
//            { Permissions.RealStateProjectOverview_TienIchKhac_DoiTrangThai, new PermissionContent { PermissionType = PermissionTypes.ButtonAction, PermissionInWeb = PermissionInWebs.RealState, ParentKey = Permissions.RealStateProjectOverview_TienIchKhac_DanhSach, Description = "Đổi trạng thái tiện ích khác" } },
//            { Permissions.RealStateProjectOverview_TienIchKhac_Xoa, new PermissionContent { PermissionType = PermissionTypes.ButtonAction, PermissionInWeb = PermissionInWebs.RealState, ParentKey = Permissions.RealStateProjectOverview_TienIchKhac_DanhSach, Description = "Xoá tiện ích khác" } },

//            { Permissions.RealStateProjectOverview_TienIchMinhHoa_DanhSach, new PermissionContent { PermissionType = PermissionTypes.Table, PermissionInWeb = PermissionInWebs.RealState, ParentKey = Permissions.RealStateProjectOverview_TienIch, Description = "Danh sách ảnh minh hoạ" } },
//            { Permissions.RealStateProjectOverview_TienIchMinhHoa_ThemMoi, new PermissionContent { PermissionType = PermissionTypes.ButtonAction, PermissionInWeb = PermissionInWebs.RealState, ParentKey = Permissions.RealStateProjectOverview_TienIchMinhHoa_DanhSach, Description = "Thêm mới ảnh minh hoạ" } },
//            { Permissions.RealStateProjectOverview_TienIchMinhHoa_CapNhat, new PermissionContent { PermissionType = PermissionTypes.ButtonAction, PermissionInWeb = PermissionInWebs.RealState, ParentKey = Permissions.RealStateProjectOverview_TienIchMinhHoa_DanhSach, Description = "Cập nhật ảnh minh hoạ" } },
//            { Permissions.RealStateProjectOverview_TienIchMinhHoa_DoiTrangThai, new PermissionContent { PermissionType = PermissionTypes.ButtonAction, PermissionInWeb = PermissionInWebs.RealState, ParentKey = Permissions.RealStateProjectOverview_TienIchMinhHoa_DanhSach, Description = "Đổi trạng thái ảnh minh hoạ" } },
//            { Permissions.RealStateProjectOverview_TienIchMinhHoa_Xoa, new PermissionContent { PermissionType = PermissionTypes.ButtonAction, PermissionInWeb = PermissionInWebs.RealState, ParentKey = Permissions.RealStateProjectOverview_TienIchMinhHoa_DanhSach, Description = "Xoá ảnh minh hoạ" } },
...
//            { Permissions.RealStateProjectOverview_CauTruc_QuanLy, new PermissionContent { PermissionType = PermissionTypes.ButtonAction, PermissionInWeb = PermissionInWebs.RealState, ParentKey = Permissions.RealStateProjectOverview_CauTruc, Description = "Quản lý" } },
...
//            { Permissions.RealStateMenuProjectListDetail_VatLieu_ChiTiet, new PermissionContent { PermissionType = PermissionTypes.Form, PermissionInWeb = PermissionInWebs.RealState, ParentKey = Permissions.RealStateMenuProjectListDetail_SoDoTK, Description = "Chi tiết" } },
//            { Permissions.RealStateMenuProjectListDetail_VatLieu_CapNhat, new PermissionContent { PermissionType = PermissionTypes.ButtonAction, PermissionInWeb = PermissionInWebs.RealState, ParentKey = Permissions.RealStateMenuProjectListDetail_SoDoTK, Description = "Cập nhật" } },
...
//            { Permissions.RealStateProjectListDetail_NhomHinhAnh, new PermissionContent { PermissionType = PermissionTypes.Form, PermissionInWeb = PermissionInWebs.RealState, ParentKey = Permissions.RealStateProjectListDetail_HinhAnhDuAn, Description = "Hình ảnh" } },
//            { Permissions.RealStateProjectListDetail_NhomHinhAnh_ChiTiet, new PermissionContent { PermissionType = PermissionTypes.ButtonAction, PermissionInWeb = PermissionInWebs.RealState, ParentKey = Permissions.RealStateProjectListDetail_HinhAnh, Description = "Chi tiết" } },
//            { Permissions.RealStateProjectListDetail_NhomHinhAnh_ThemMoi, new PermissionContent { PermissionType = PermissionTypes.ButtonAction, PermissionInWeb = PermissionInWebs.RealState, ParentKey = Permissions.RealStateProjectListDetail_HinhAnh, Description = "Thêm mới" } },
//            { Permissions.RealStateProjectListDetail_NhomHinhAnh_CapNhat, new PermissionContent { PermissionType = PermissionTypes.ButtonAction, PermissionInWeb = PermissionInWebs.RealState, ParentKey = Permissions.RealStateProjectListDetail_HinhAnh, Description = "Cập nhật" } },
//            { Permissions.RealStateProjectListDetail_NhomHinhAnh_DoiTrangThai, new PermissionContent { PermissionType = PermissionTypes.ButtonAction, PermissionInWeb = PermissionInWebs.RealState, ParentKey = Permissions.RealStateProjectListDetail_HinhAnh, Description = "Đổi trạng thái" } },
//            { Permissions.RealStateProjectListDetail_NhomHinhAnh_Xoa, new PermissionContent { PermissionType = PermissionTypes.ButtonAction, PermissionInWeb = PermissionInWebs.RealState, ParentKey = Permissions.RealStateProjectListDetail_HinhAnh, Description = "Xoá" } },

//            // Menu Phân phối
//            { Permissions.RealStateMenuPhanPhoi, new PermissionContent { PermissionType = PermissionTypes.Form, PermissionInWeb = PermissionInWebs.RealState, ParentKey = Permissions.RealStateProjectListDetail_HinhAnhDuAn, Description = "Hình ảnh" } },
//            { Permissions.RealStatePhanPhoi_DanhSach, new PermissionContent { PermissionType = PermissionTypes.ButtonAction, PermissionInWeb = PermissionInWebs.RealState, ParentKey = Permissions.RealStateProjectListDetail_HinhAnh, Description = "Chi tiết" } },
//            { Permissions.RealStatePhanPhoi_ThemMoi, new PermissionContent { PermissionType = PermissionTypes.ButtonAction, PermissionInWeb = PermissionInWebs.RealState, ParentKey = Permissions.RealStateProjectListDetail_HinhAnh, Description = "Thêm mới" } },
//            { Permissions.RealStatePhanPhoi_DoiTrangThai, new PermissionContent { PermissionType = PermissionTypes.ButtonAction, PermissionInWeb = PermissionInWebs.RealState, ParentKey = Permissions.RealStateProjectListDetail_HinhAnh, Description = "Cập nhật" } },
//            { Permissions.RealStatePhanPhoi_Xoa, new PermissionContent { PermissionType = PermissionTypes.ButtonAction, PermissionInWeb = PermissionInWebs.RealState, ParentKey = Permissions.RealStateProjectListDetail_HinhAnh, Description = "Đổi trạng thái" } },
//            { Permissions.RealStatePhanPhoi_ChiTiet, new PermissionContent { PermissionType = PermissionTypes.ButtonAction, PermissionInWeb = PermissionInWebs.RealState, ParentKey = Permissions.RealStateProjectListDetail_HinhAnh, Description = "Xoá" } },
