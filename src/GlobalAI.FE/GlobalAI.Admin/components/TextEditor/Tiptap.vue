<template>
    <div class="border border-gray-400 rounded-md my-2">
        <div :editor="editor" v-if="editor" class="flex flex-row space-x-2 border-b border-b-gray-400 p-2 text-gray-500">
            ...
            <button :class="{ 'font-bold': editor?.isActive('strike') }"
            ...
            <button :class="{ 'is-active': editor?.isActive('heading', { level: 1 }) }" size="small"
        ...
        <ImageModalVue name="imageModal" @upload-image-success="data => uploadImageSuccess(data)" />
    </div>
</template>
