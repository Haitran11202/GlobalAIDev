<template>
    <div class="w-full mt-[40px] cursor-pointer">
        <div class="flex w-full justify-between items-center mb-[20px]">
            <h1
                class="lg:text-[24px] sm:pl-0 pl-4 text-[#384059] uppercase font-bold"
            >
                {{ props?.category }}
            </h1>
            <RouterLink
        ...
        >
            ...
            >
                ...
                <div class="bg-white flex flex-col gap-[4px] pt-2">
                    <div class="px-[10px]">
                        <h2
                            class="text-[18px] leading-[1.3] h-[46.8px] text-ellipsis line-clamp-2 uppercase text-[#384059]"
                        >
                            {{ item.tenSanPham }}
                        </h2>
