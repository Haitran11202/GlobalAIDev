    ...
    <div class="flex flex-wrap relative">
      ...
      <div class="mt-[40px]">
        ...
        <div class="flex gap-[10px] items-center w-full">
           <div class="w-[20%]">
            <img class="rounded-xl" src="https://media.sellycdn.net/files/sm_2022_12_05_11_32_49_0700_SPjLbUCOmT.jpg" alt="">
           </div>
           <div class="w-[20%]">
            <img class="rounded-xl" src="https://media.sellycdn.net/files/sm_2022_08_01_06_47_17_0700_HgNKtIVXdM.jpg" alt="">
           </div>
           <div class="w-[20%]">
