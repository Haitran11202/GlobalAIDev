<template>
    <div class="mt-[20px] min-h-[100vh]">
        ...
        <div class="flex w-full gap-[30px] lg:flex-row flex-col">
            <div
                class="lg:w-[65%] mb-[40px] mt-[20px] rounded-md overflow-hidden"
            >
                <div
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <div class="px-[35px] mt-[40px]">
                                <div class="flex gap-[20px]">
                                    ...
                                    <div>
                                        <h1
                                            class="text-[18px] uppercase text-[#384059] font-bold"
                                        >
                                            {{ sanpham.tenSanPham }}
                                        </h1>
                                        <div class="flex gap-[20px]">
                                ...
                                >
                                    ...
                                    <p>
                                        Sản phẩm đang được khuyến mãi với nhiều
                                        ưu đãi đặc biệt quý khách không nên bỏ
                                        qua nhé
                                    </p>
                                </div>
                                <div
                                ...
                                >
                                    <h2
                                        class="font-bold text-[18px] text-[#384059]"
                                    >
                                        Số lượng
                                    </h2>
                                    <div
                                ...
                                >
                                    ...
                                    <p
                                        class="float-right text-[#23c6c8] text-[18px] font-medium"
                                    >
                                        {{ formatMoneyAll(getPriceUpdate()) }}
                                    </p>
                                </div>
                                <div
                                    class="w-full mt-[40px] flex items-center justify-center"
                                >
                                    <div>
                                        <button
                                            @click="
                        ...
                        >
                            ...
                            <div
                                class="flex items-center justify-center mt-[60px]"
                            >
                                <svg
                                    width="91"
                                    height="90"
            ...
            >
                            ...
                            <div class="mt-4">
                                <div class="w-full lg:flex gap-[30px]">
                                    <div class="w-[50%] px-[10px]">
                                        <h2
                                            class="text-[16px] text-[#384059] font-[500]"
                                        >
                                            Địa chỉ
                                        </h2>
                                        <div class="w-full">
                                ...
                                <div
                                    class="w-full flex cursor-pointer items-center mt-[40px]"
                                >
                                    <button
                                        type="submit"
                ...
                <div>
                    ...
                    <h1 class="text-[18px] font-bold mt-[15px]">
                    ...
                    <div class="flex items-center justify-center">
                        <label class="label cursor-pointer mt-10">
                            <input
                                ...
                                class="checkbox"
                            />
                            <span class="label-text mr-3"
                                >&nbsp;Đồng ý điều khoản</span
                            >
                        </label>
                    </div>
                    <div class="flex mt-[20px] justify-between flex-col">
                        <div class="flex flex-row items-center justify-between">
                            <h1 class="mt-2 text-[18px] font-bold">
                                Tổng Thanh Toán
                            </h1>
                            <p
                                class="text-lg text-[18px] font-bold text-[#cc3366]"
                            >
