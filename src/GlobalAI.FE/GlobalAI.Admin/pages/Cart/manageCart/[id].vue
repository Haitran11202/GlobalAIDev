                    ...
                    <div class="w-full">
                      ...
                      <div>
                        ...
                        >
                          ...
                          <option value="Hòai Đức">Hòai Đức</option>
                        </select>
                      </div>
                      <select
                        name="city"
                      ...
                      >
                        ...
                        <option value="Hương Sơn">Hương Sơn</option>
                        <option value="Đặng Xá">Đặng Xá</option>
                        <option value="Đình Xuyên">Đình Xuyên</option>
                        <option value="Phú Thị">Phú Thị</option>
                      </select>
                    </div>
                    <input
                      type="text"
        ...
        <div>
          ...
          <div class="flex mt-[20px] justify-between flex-col">
            ...
            <div class="mt-5 float-right">
              ...
              <div class="modal">
                <div class="modal-box bg-[#F5F5F5] p-[30px] w-12/12 max-w-7xl">
                  ...
                  <div class="flex flex-col gap-2">
                    <div class="flex w-full bg-white shadow-sm border py-5">
                    ...
                    <div>
                      <div>
                        <div class="overflow-x-auto flex flex-col gap-4">
                          <table class="table bg-white border-[1px] flex gap-">
                            <!-- head -->
                            <thead>
                              <tr>
                            ...
                            <tbody
                              ...
                              v-for="(
                                donhang, index
                              ) in selectedProductCheckout"
                              :key="index"
                            >
                              <td class="p-3 w-auto font-medium">
                                {{ donhang.donHang.maDonHang }}
                              </td>
                              <tr
                                class=""
                                v-for="(
                                  ct, index
                                ) in donhang.chiTietDonHangFullDtos"
                                :key="index"
                              >
                                <td class="flex p-6 gap-4 h-[100%]">
                                  <div>
                                    <img
                                      class="object-cover w-[50px]"
                                      :src="getImageUrl(ct.thumbnail)"
                                    />
                                  </div>
