<template>
  <div>
    ...
    <div class="card lg:card-side bg-base-100 shadow-xl">
      <figure><img src="~/assets/images/vue.jpg" alt="Album" /></figure>
      <div class="card-body">
        <h2 class="card-title">Gà rán giòn rụm</h2>
            ...
            <li>
              <a class="">
                ...
                <router-link
                  ...
                  >Thông tin nhà cung cấp</router-link
                >
        ...
        >
          <div class="px-4 py-5 flex-auto">
            <div class="tab-content tab-space">
              ...
              >
                <p>
                  Gà rán miền Nam Hoa Kỳ, hay còn gọi là gà rán, là một món ăn
                  xuất xứ từ miền Nam Hoa Kỳ; nguyên liệu chính là những miếng
                  thịt gà đã được lăn bột rồi chiên trên chảo, chiên ngập dầu,
                  chiên áp suất hoặc chiên không dầu.
                </p>
              </div>
              <div
