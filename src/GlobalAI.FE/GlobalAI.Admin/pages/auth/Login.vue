    ...
    <div class="bg-no-repeat bg-cover bg-center relative bg-login">
        ...
        <div class="min-h-screen sm:flex sm:flex-row mx-0 justify-center">
            ...
            <div class="flex justify-center self-center z-10">
                <Form class="max-w-sm" @submit="logInFunc" :validationSchema="loginBody">
                    <div class="p-12 bg-white rounded-2xl">
                        ...
                        <div class="flex items-center justify-center mt-3">
                            <label class="text-gray-800 text-sm">
                                ...
                                <nuxt-link to="/auth/registermaster" class="text-emerald-500 underline">đăng ký</nuxt-link>
                            </label>
                        </div>
                        <div class="pt-5 text-center text-gray-400 text-xs">
                            <span>
                                Bản quyền thuộc
                                <a href="http://localhost:8001/auth/login" rel="" target="_blank" title="Global AI"
                                    class="text-green hover:text-green-500">Global AI</a>
                                © 2023
                            </span>
                        </div>
                    </div>
