      ...
      <div class="flex flex-col gap-5">
        ...
        >
          <div class="flex justify-between items-center">
              ...
              <div>
                ...
                >
                  ...
                  >
                    ...
                    />
                    <span
                      @click="addInputField(item.idDanhMucThuocTinh)"
                      class="m-5 text-sm cursor-pointer"
            ...
            <div>
              <span
                class="m-5 text-2xl cursor-pointer"
                @click="addListThuocTinh"
                ><font-awesome-icon icon="fa-plus"
              /></span>
            </div>
          </div>
...
function addInputField(index) {
  console.log(filterListThuocTinhOfItems.value);
  filterListThuocTinhOfItems.value[index].listThuocTinhGiaTri.push({
    idThuocTinh: randomId(10),
    giaTri: "",
  });
}

function addListThuocTinh() {
  filterListThuocTinhOfItems.value.push({
    idDanhMucThuocTinh: filterListThuocTinhOfItems.value.length,
    tenThuocTinh: "Tên thuộc tính mới",
    listThuocTinhGiaTri: [
      {
        idThuocTinh: randomId(10),
        giaTri: "",
