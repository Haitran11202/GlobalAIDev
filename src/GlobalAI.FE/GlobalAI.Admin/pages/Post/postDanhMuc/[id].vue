                        ...
                        >
                            ...
                            >
                                ...
                                <div class="pt-2 pr-0 pb-0 pl-0">
                                    ...
                                    >
                                    <p
                                        class="inline text-sm font-medium mt-0 mr-1 mb-0 ml-1"
                                    >
                                        · 31/03/2023 ·
                                    </p>
                                    <p
                    ...
                    <div class="grid grid-cols-12 sm:px-5 gap-x-8 gap-y-16">
                        ...
                        >
                            ...
                            <p class="text-sm text-black">
                                Tin tức mới nhất về Liverpool: Thông tin, hình
                                ảnh, sự kiện và video nổi bật liên quan
                                Liverpool được cập nhật nhanh và liên tục.
                            </p>
                            <div class="pt-2 pr-0 pb-0 pl-0">
                                <p class="text-sm font-medium inline">
                                    Tác giả:
