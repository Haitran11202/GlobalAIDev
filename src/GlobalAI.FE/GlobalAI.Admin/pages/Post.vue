    ...
    <div class="flex flex-col items-center sm:px-5 md:flex-row">
      <div class="flex flex-col items-start justify-center w-full h-full pt-6 pr-0 pb-6 pl-0 mb-6 md:mb-0 md:w-1/2">
        <div class="flex flex-col items-start justify-center h-full space-y-3 transform md:pr-10 lg:pr-16
          ...
          <a class="text-4xl font-bold leading-none lg:text-5xl xl:text-6xl">Hoa quả tươi ? Có tốt cho sức khỏe</a>
          <div class="pt-2 pr-0 pb-0 pl-0">
            ...
            <p class="inline text-sm font-medium mt-0 mr-1 mb-0 ml-1">· 31/03/2023 ·</p>
            <p class="text-gray-200 text-sm font-medium inline mt-0 mr-1 mb-0 ml-1">1h 20p</p>
          </div>
        </div>
      </div>
    ...
    <div class="grid grid-cols-12 sm:px-5 gap-x-8 gap-y-16">
      <div class="flex flex-col items-start col-span-12 space-y-3 sm:col-span-6 xl:col-span-4">
        ...
        <p class="bg-green-500 flex items-center leading-none text-sm font-medium text-gray-50 pt-1.5 pr-3 pb-1.5 pl-3
            rounded-full uppercase inline-block">Giải trí</p>
        <a class="text-lg font-bold sm:text-xl md:text-2xl">Câu lạc bộ bóng đá Liverpool</a>
        <p class="text-sm text-black">Tin tức mới nhất về Liverpool: Thông tin, hình ảnh, sự kiện và video nổi bật liên quan Liverpool được cập nhật nhanh và liên tục.</p>
        <div class="pt-2 pr-0 pb-0 pl-0">
         <p class="text-sm font-medium inline">Tác giả:</p>
            <a class="inline text-sm font-medium mt-0 mr-1 mb-0 ml-1 underline">Hidden</a>
            <p class="inline text-sm font-medium mt-0 mr-1 mb-0 ml-1">· 31/03/2023 ·</p>
      ...
      <div class="flex flex-col items-start col-span-12 space-y-3 sm:col-span-6 xl:col-span-4">
       ...
       <p class="bg-green-500 flex items-center leading-none text-sm font-medium text-gray-50 pt-1.5 pr-3 pb-1.5 pl-3
            rounded-full uppercase inline-block">Động vật</p>
        <a class="text-lg font-bold sm:text-xl md:text-2xl">Chó, là một loài động vật thuộc chi Chó</a>
        <p class="text-sm text-black">Chó cũng là loài động vật đầu tiên được con người thuần hóa và đã được chọn giống qua hàng thiên niên kỷ với nhiều hành vi, khả năng cảm nhận và đặc tính vật lý ...</p>
        <div class="pt-2 pr-0 pb-0 pl-0">
         <p class="text-sm font-medium inline">Tác giả:</p>
            <a class="inline text-sm font-medium mt-0 mr-1 mb-0 ml-1 underline">Hidden</a>
            <p class="inline text-sm font-medium mt-0 mr-1 mb-0 ml-1">· 31/03/2023 ·</p>
      ...
      <div class="flex flex-col items-start col-span-12 space-y-3 sm:col-span-6 xl:col-span-4">
       ...
       <p class="bg-green-500 flex items-center leading-none text-sm font-medium text-gray-50 pt-1.5 pr-3 pb-1.5 pl-3
            rounded-full uppercase inline-block">Tiêu dùng</p>
        <a class="text-lg font-bold sm:text-xl md:text-2xl">Những loại bánh ngọt nổi tiếng trên thế giớ</a>
        <p class="text-sm text-black">Bánh ngọt hay bánh ga-tô là một thuật ngữ chung cho bánh có nguồn gốc từ phương Tây. Bánh một dạng thức ăn ngọt làm từ bột mì, đường và các thành phần khác, thường được nướng.</p>
        <div class="pt-2 pr-0 pb-0 pl-0">
         <p class="text-sm font-medium inline">Tác giả:</p>
            <a class="inline text-sm font-medium mt-0 mr-1 mb-0 ml-1 underline">Hidden</a>
            <p class="inline text-sm font-medium mt-0 mr-1 mb-0 ml-1">· 31/03/2023 ·</p>
